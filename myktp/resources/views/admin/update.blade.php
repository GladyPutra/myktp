          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Nama Penduduk: {{ $citizen['fullname'] }}</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br/>
                    {!! Form::model($citizen, ['route'=>['update', $citizen->id], 'method'=> 'PATCH', 'id'=>'demo-form2', 'data-parsley-validate class'=>'form-horizontal form-label-left'])  !!}
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Fullname
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="fullname" required="required" placeholder="Fullname" class="form-control col-md-7 col-xs-12" value="{{ $citizen['fullname'] }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="nik" required="required" placeholder="NIK" class="form-control col-md-7 col-xs-12" value="{{ $citizen['nik'] }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="gender" class="btn-group">
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="gender" value="Male" <?php if($citizen['gender'] == "Male") echo "checked"; ?>> &nbsp; Male &nbsp;
                            </label>
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="gender" value="Female" <?php if($citizen['gender'] == "Female") echo "checked"; ?>> Female
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="place_of_birth" required="required" placeholder="Place of Birth" class="form-control col-md-7 col-xs-12" value="{{ $citizen['place_of_birth'] }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="last-name" name="birth_date" required="required" placeholder="Birth Date" class="form-control col-md-7 col-xs-12" value="{{ $citizen['birth_date'] }}">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="address" required="required" placeholder="Address" class="form-control col-md-7 col-xs-12">{{ $citizen['address'] }}</textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="job" required="required" placeholder="Place of Birth" class="form-control col-md-7 col-xs-12" value="{{ $citizen['job'] }}">
                        </div>
                      </div>
                      <div class="form-group">
