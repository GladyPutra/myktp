            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <?php echo Form::model($peserta, ['route'=>['peserta.update', $peserta->id], 'method'=> 'PATCH', 'id'=>'demo-form2', 'data-parsley-validate class'=>'form-horizontal form-label-left']); ?>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="first_name" required="required" placeholder="Nama Depan" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['first_name']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="last_name" required="required" placeholder="Nama Belakang" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['last_name']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">NPM</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" placeholder="NPM" class="form-control col-md-7 col-xs-12" type="text" name="npm" value="<?php echo e($peserta->pengusul['npm']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="middle-name" name="prodi" placeholder="Program Studi" class="form-control col-md-7 col-xs-12">
                            <?php $__currentLoopData = $prodi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option value="<?php echo e($data->id); ?>" <?php if($data->id == $peserta->pengusul['prodi_id']) echo "selected";?>><?php echo e($data->prodi_name); ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                          <input type="date" name="born_date" class="date-picker form-control col-md-7 col-xs-12" required="required" value="<?php echo e($peserta->pengusul['born_date']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" name="address" required="required" placeholder="Alamat" class="form-control col-md-7 col-xs-12"><?php echo e($peserta->pengusul['address']); ?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="username" placeholder="Username" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['username']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="email" required="required" placeholder="Email" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['email']); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Nomor Telepon</label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" name="contact_number" required="required" placeholder="Nomor Telepon" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['contact_number']); ?>">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" name="line_id" placeholder="Id Line" class="form-control col-md-7 col-xs-12" value="<?php echo e($peserta->pengusul['line_id']); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="<?php echo e(route('peserta.index')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
                        </div>
                      </div>
                    </form>
                    <?php echo Form::close(); ?>
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            <div class="x_content">
                              <br />
                              <form action="<?php echo e(route('peserta.store_pkm')); ?>" method="post" class="form-horizontal form-label-left input_mask">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 form-group has-feedback">
                                  ...
                                  <input type="hidden" name="id_pengusul" value="<?php echo e($peserta->id_pengusul); ?>">
                            ...
                            <?php if($proposal->count()): ?>
                                <table id="datatable" class="table table-striped table-bordered">
                                  ...
                                  <?php $__currentLoopData = $proposal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                        ...
                                        <td width="150px">
                                          <?php echo Form::model($data, ['route'=>['peserta.update_pkm', $data->id], 'method'=> 'PATCH', 'files'=>true]); ?>
                                        ...
                                        <td align="center">
                                          ...
                                          <?php echo Form::model($data, ['route'=>['peserta.upload_pkm', $data->id], 'method'=> 'PATCH', 'files'=>true, 'id'=>'asd','style' => 'display:none;']); ?>
                                ...
                                <?php echo Form::model($data, ['route'=>['peserta.upload_review', $data->id], 'method'=> 'PATCH', 'files'=>true,]); ?>
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            <div class="x_content">
                              ...
                              <form action="<?php echo e(route('peserta.storeanggota')); ?>" method="post" class="form-horizontal form-label-left input_mask">
                                <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="id_proposal" value="<?php echo e($proposal2->id); ?>">
                                <input type="hidden" name="id_pengusul" value="<?php echo e($proposal2->id_pengusul); ?>">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                  ...
                                  <?php $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr>
                                        ...
                                        <td align="center">
                                          <form method="POST" action="<?php echo e(route('peserta.destroy_anggota', $data->id)); ?>" accept-charset="UTF-8">
                                            <input name="_method" type="hidden" value="DELETE">
                                            <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                                            <input type="hidden" name="id_pengusul" value="<?php echo e($data->id_pengusul); ?>">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_content">
                                    <br>
                                  <?php if(!empty($cek_proposal)): ?>
                                  <form action="<?php echo e(route('peserta.storedosen')); ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <?php echo e(csrf_field()); ?>
