                      ...
                      <td align="center">
                        <form method="POST" action="<?php echo e(route('destroy', $data->id)); ?>" accept-charset="UTF-8">
                          ...
                          <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                            <a class='btn btn-primary btn-xs' href="<?php echo e(route('detail', $data->id)); ?>"><i class="fa fa-info-circle"></i> Details</a>
                            <a target="_blank" class='btn btn-default btn-xs' href="http://kssc07.bismaoperation.id/api/viewImages.php?id=<?php echo e($data->id); ?>"><i class="fa fa-info-circle"></i> View Image</a>
