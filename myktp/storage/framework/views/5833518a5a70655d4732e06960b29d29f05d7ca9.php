        ...
        <div class="  ">
            <div class="content"><br><br>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                  <textarea type="text" readonly name="ketentuan" class="form-control has-feedback-left" id="inputSuccess2" rows="17" placeholder="Ketentuan PKM"><?php echo e($ketentuan_temp); ?></textarea>
                  <span class="fa fa-file form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="links">
                    <a href="<?php echo e(route('register.index')); ?>">Daftar</a>
                    <a href="<?php echo e(route('login.index')); ?>">Login</a>
                    <a href="<?php echo e(route('login.download')); ?>"><?php echo e($pedoman_temp); ?></a>
                </div>
                <br><br>
            </div>
        </div>
