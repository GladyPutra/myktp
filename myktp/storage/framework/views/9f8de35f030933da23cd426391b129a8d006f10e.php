              ...
              <table id="datatable" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <td align="center"><b>Kewarganegaraan</b></td>
                      ...
                      <td align="center">
                        <form method="POST" action="<?php echo e(route('peserta.destroy', $data->id)); ?>" accept-charset="UTF-8">
                          ...
                          <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                            ...
                            <a target="_blank" href="<?php echo e(route('pengusul.read', $data->id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> Edit</a>
