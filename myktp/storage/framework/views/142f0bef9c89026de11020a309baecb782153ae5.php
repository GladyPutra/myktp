                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        ...
                        <div class="col-xs-2">
                          <label class="col-md-6 col-sm-6" for="last-name">: <?php echo e(Auth::User()->username_dikti); ?></label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-xs-2" for="last-name">Password</label>
                        <div class="col-xs-2">
                          <label class="col-md-6 col-sm-6" for="last-name">: <?php echo e(Auth::User()->password_dikti); ?></label>
                        </div>
                      </div>
                    </form>
                  </div>
