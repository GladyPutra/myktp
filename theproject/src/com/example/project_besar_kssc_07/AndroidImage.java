...
public class AndroidImage {
	 ...
	 * Constructor
	 *
	 * @param img the Bitmap from which we create our AndroidImage
	Object
	 */
	 ...
	 */
	 ...
	 /**
	  * Method to set color array for image - called on initialization by
	 constructor
	  *
	  *
	  */
	   ...
	   */
	   ...
	   /**
	   * Method to set the color of a specified pixel from an RGB
	   combination
	   *
	   * @param x
	   * @param y
	   ...
	   */
	   public void rotate (int rotateDegrees){
		   ...
		   image = Bitmap. createBitmap(image, 0, 0, width, height, mtx,
		   true);
